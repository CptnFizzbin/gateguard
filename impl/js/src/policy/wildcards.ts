...
/** meta.anyAction: absent -> "_ANY_" operators; explicit string -> that string; explicit null -> DISABLED. */
...
/** meta.anySubject: absent -> "_ANY_" operators; explicit string -> that string; explicit null -> DISABLED. */
